  ...
  return (
    <section className="relative z-20 -mt-8 pb-6 pt-4 sm:-mt-32 sm:pb-8 sm:pt-6">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <span className="absolute left-[8%] top-1/2 size-72 -translate-y-1/2 rounded-full bg-royal-bright/35 blur-[90px] dark:bg-royal-bright/25" />
        <span className="absolute left-1/2 top-1/3 size-72 -translate-x-1/2 rounded-full bg-emerald/28 blur-[90px] dark:bg-emerald/20" />
        <span className="absolute right-[8%] top-1/2 size-72 -translate-y-1/2 rounded-full bg-amber/28 blur-[90px] dark:bg-amber/20" />
      </div>
