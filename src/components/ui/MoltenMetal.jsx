...
/**
 * MoltenMetal — from React Bits (reactbits.dev), JavaScript + CSS variant.
 *
 * Kept as the library ships it so it can be diffed against upstream. The one
 * addition is the "use client" directive above: it holds a WebGL context and
 * measures the DOM, neither of which survives a server render.
 */
